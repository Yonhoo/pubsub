...
const file_protocol_protocol_proto_rawDesc = "" +
	"\n" +
	"\x17protocol/protocol.proto\x12\bprotocol\"O\n" +
	"\x05Proto\x12\x10\n" +
	"\x03ver\x18\x01 \x01(\x05R\x03ver\x12\x0e\n" +
	"\x02op\x18\x02 \x01(\x05R\x02op\x12\x10\n" +
	"\x03seq\x18\x03 \x01(\x05R\x03seq\x12\x12\n" +
	"\x04body\x18\x04 \x01(\fR\x04bodyBEZCgithub.com/livekit/psrpc/examples/pubsub/protocol/protocol;protocolb\x06proto3"
